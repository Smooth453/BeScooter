...
export function Footer() {
  return (
    <footer className="border-gray-900  bg-gradient-to-br from-green-400 to-blue-400 p-4">
      ...
      <div className=":gap-6 :grid-cols-3 grid-cols-3 justify-items-center text-lg uppercase text-black md:grid   md:justify-end md:gap-8">
        ...
        <div>
          ...
          <ul className="text-gray-900 dark:text-gray-700">
            ...
            <li>
              <Link
                href="info#Cookie-Einstellungen"
                className="text-lg hover:bg-slate-100 hover:bg-opacity-50 hover:text-slate-900 "
              >
      ...
      <div className="flex justify-center">
        <div className="flex flex-wrap items-center justify-center">
          <span className="text-sm dark:black text-center text-black">
            UST-ID.: DE815814992
          </span>
          <span className="text-sm dark:black text-center text-black w-full">
            © 2023{' '}
